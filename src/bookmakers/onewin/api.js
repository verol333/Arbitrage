...
// Tennis : plusieurs sportIds possibles (top-parser expose parfois 12 ou 4
// selon la region). On tente les 2, dedup par match.id.
export const WIN_SID_ALT = { basketball: [19, 23], tennis: [12, 4] };
